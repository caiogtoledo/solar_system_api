...
from src.modules.get_battery_prediction.app.get_battery_prediction_presenter import get_battery_prediction_presenter
from src.modules.get_battery_prediction_time.app.get_battery_prediction_time_presenter import get_battery_prediction_time_presenter
...
@app.route('/get-battery-prediction', methods=['POST', 'GET'])
def get_battery_prediction():
    return flask_route(request, get_battery_prediction_presenter)


@app.route('/get-battery-prediction-time', methods=['POST', 'GET'])
def get_battery_prediction_time():
    return flask_route(request, get_battery_prediction_time_presenter)
